...
**Evaluated**: `{{TIMESTAMP}}`
**Evaluator**: code-quality-judge ({{MODEL_VERSION}})
...
|-----------|-------|--------|----------------|
| 1. Module Structure & Architecture | {{DIM1_SCORE}}/10 | 25% | {{DIM1_WEIGHTED}} |
...
### 1. Module Structure & Architecture: {{DIM1_SCORE}}/10 (Weight: 25%)
...
| Semantic versioning | 7.2 | {{CONST_2_STATUS}} | {{CONST_2_EVIDENCE}} | {{CONST_2_NOTES}} |
| Ephemeral credentials | 4.1 | {{CONST_3_STATUS}} | {{CONST_3_EVIDENCE}} | {{CONST_3_NOTES}} |
| Least privilege IAM | 4.4 | {{CONST_4_STATUS}} | {{CONST_4_EVIDENCE}} | {{CONST_4_NOTES}} |
| Encryption at rest | 4.4 | {{CONST_5_STATUS}} | {{CONST_5_EVIDENCE}} | {{CONST_5_NOTES}} |
| Testing framework | 6.3 | {{CONST_6_STATUS}} | {{CONST_6_EVIDENCE}} | {{CONST_6_NOTES}} |
| Pre-commit validation | 6.3 | {{CONST_7_STATUS}} | {{CONST_7_EVIDENCE}} | {{CONST_7_NOTES}} |
...
| **Judge Version** | code-quality-judge v1.0 ({{MODEL_VERSION}}) |
