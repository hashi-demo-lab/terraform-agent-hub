...
TFLINT_VERSION=${3:-"0.59.1"}
TFLINT_AWS_RULESET_VERSION=${4:-"0.23.1"}
TFLINT_AZURE_RULESET_VERSION=${5:-"0.23.0"}
TFLINT_GCP_RULESET_VERSION=${6:-"0.23.1"}
INFRACOST_VERSION=${7:-"0.10.42"}
CHECKOV_VERSION=${8:-"3.2.489"}
VAULT_RADAR_VERSION=${9:-"0.36.0"}
